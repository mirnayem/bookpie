...
import type { Author, Book, Category, Publisher, UpsertBookRequest } from "@bookpie/shared";
...
export function ProductForm({ authors, publishers, categories, book, busy, onSubmit }: ProductFormProps) {
